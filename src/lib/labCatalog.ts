...
export const LAB_ANALYTES: LabAnalyte[] = [
  ...
  { key: 'TBIL',  labelKo: '빌리루빈',  labelEn: 'Bilirubin',      defaultUnit: 'mg/dL',  templates: ['liver'], valueType: N, graphable: true, aliases: ['Total Bilirubin', 'T-BIL', 'TBil'] },
  ...
  { key: 'URINE_WBC',     labelKo: '백혈구(뇨)',  labelEn: 'WBC (urine)', defaultUnit: '/HPF', templates: ['urine'], valueType: TXT, graphable: false },
  ...
  { key: 'T4',    labelKo: '갑상선 T4',    labelEn: 'T4',            defaultUnit: 'µg/dL',   templates: ['endocrine'], valueType: N, graphable: true, aliases: ['Total T4', 'TT4'] },
