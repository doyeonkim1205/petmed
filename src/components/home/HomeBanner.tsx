  ...
  return (
    <div className="px-4 pt-4">
      <button
        ...
        className={`relative w-full text-left rounded-2xl overflow-hidden h-40 bg-gradient-to-br ${banner.gradient} px-5 pt-4 pb-10 flex flex-col justify-center text-white shadow-sm transition-transform active:scale-[0.99]`}
      >
        {/* 장식 — 은은한 반투명 원 (깊이감) */}
