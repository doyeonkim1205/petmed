...
export function OnboardHint({
  ...
  return (
    <div className="relative flex items-start gap-2 rounded-lg border border-blue-300 bg-white px-2.5 py-2 text-[11px] font-medium text-gray-900 shadow-md">
      {pointer !== 'none' && (
        <span className={`absolute -top-1 ${tail} w-2 h-2 rotate-45 border-l border-t border-blue-300 bg-white`} />
      )}
