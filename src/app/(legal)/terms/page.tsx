  ...
  return (
    <article className="prose prose-sm dark:prose-invert max-w-none">
      ...
      <Section title="제2조 (정의)">
        <ol>
          <li>&quot;서비스&quot;란 PawDex가 제공하는 반려동물 건강 정보 검색, 건강 기록 관리, 동물병원 찾기, 커뮤니티 등 일체의 서비스를 말합니다.</li>
          <li>&quot;회원&quot;이란 서비스에 가입하여 이용 계약을 체결한 자를 말합니다.</li>
          <li>&quot;콘텐츠&quot;란 서비스 내에서 회원이 작성한 게시글, 댓글, 건강 기록 등 일체의 정보를 말합니다.</li>
        </ol>
      </Section>
