  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="flex items-center gap-3 px-4 py-3 sticky top-0 bg-white z-10 border-b border-gray-100">
        ...
        <h1 className="text-sm font-semibold text-gray-700">내가 본 논문</h1>
      </header>
      ...
      <div className="p-4 space-y-3">
        {analyses.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-sm text-gray-400">저장된 논문이 없습니다.</p>
            <p className="text-xs text-gray-300 mt-1">검색 결과에서 논문을 저장해보세요.</p>
          </div>
        ) : (
          analyses.map((item) => (
