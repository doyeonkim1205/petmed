...
const QUICK_LINKS = [
  { icon: Activity, key: 'stats', color: 'text-indigo-500', href: '/records/stats' },
  { icon: Pill, key: 'meds', color: 'text-indigo-500', href: '/records/meds' },
  { icon: Syringe, key: 'preventive', color: 'text-indigo-500', href: '/records/preventive' },
  { icon: Wallet, key: 'expenses', color: 'text-indigo-500', href: '/records/expenses' },
] as const;
