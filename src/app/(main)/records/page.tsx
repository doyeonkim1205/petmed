...
const QUICK_LINKS = [
  ...
  { icon: Pill, key: 'meds', color: 'text-blue-500', href: '/records/meds' },
  { icon: Syringe, key: 'preventive', color: 'text-blue-500', href: '/records/preventive' },
  { icon: Wallet, key: 'expenses', color: 'text-blue-500', href: '/records/expenses' },
] as const;
